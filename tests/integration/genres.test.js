...
in beforeEach and afterEach function we load and close the server |everytime we run the tests
...
describe('/api/genres', () => {
  ...
  describe('GET /:id', () => {
    it('should return a genre if valid id is passed', async () => {
      ...
      // when we store the genre mongoose sets the _id to an objectId but when we read it the id will be a string
  ...
  describe('POST /', () => {
    ...
    // can i avoid this await/async? return immediately, so i return a promise and then await later?? like i do in auth middleware test!
    const exec = async () => {
